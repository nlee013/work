...
<script type="text/javascript">
	...
	function findId() {
		...
		f.action = "<%=cp%>/homesool/id_ok.com";
		f.submit();
...
<tr>
	<td height="100" align="center" colspan="3" style="font-size: 35px">아이디 찾기</td>
</tr>
			...
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input m-b-16" align="center">
						<input class="input100" type="text" name="user_name" placeholder="등록 이름"
				...
				<br/>
					...
					<div class="container-login100-form-btn m-t-17" align="center">
						...
						<button onclick="findId();" class="login100-form-btn" style="width :480px; height :65px; color : #fff; background-color: #eda71a; border: 0">
						아이디 찾기
						</button>
					</div>
					<br/>
