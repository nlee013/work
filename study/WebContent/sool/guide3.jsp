...
<!-- saved from url=(0054)https://www.homesool.com/service/membership_lounge.php -->
...
<!-- 애매 -->
	...
	<div class=""><a href="https://www.homesool.com/service/membership_lounge.php#;" class="close"><img src="<%=cp%>/sool/main_files/btn_close38.png" alt="닫기"></a></div>
</div>
<!-- //top_search -->
				<!-- 검색 폼 -->
            	<ul class="icon_util">	   
					<li><a href="https://www.homesool.com/service/membership_lounge.php#;" class="icon_location">배송지역가능조회</a></li>
            		<li>
        ...
        <!-- 본문 시작 -->
            ...
            <div class="location_wrap">
                <div class="location_cont">
                    <em><a href="https://www.homesool.com/service/membership_lounge.php#" class="local_home">HOME</a> &gt; 홈술가이드 &gt; 홈술 멤버십</em>
                </div>
            </div>
            <!-- //location_wrap -->
...
<div class="content">
	...
	<div class="louge01 w860"> 
		...
		<p class="louge_img mt30"><img src="<%=cp%>/sool/main_files/louge_img.jpg" alt=""></p>
        ...
        <div class="foot_info">
            ...
            <div class="foot_info_list">
				...
				<div>
					...
					<span>통신판매업신고번호 : 제 2020-경기포천-0287 호 <a href="https://www.homesool.com/service/membership_lounge.php#" class="btn_licensee_info" onclick="gd_popup_bizInfo(&#39;8828501179&#39;); return false;">[사업자정보확인] </a></span> 
				</div> 
				<div>
            ...
            <div class="foot_info_list">
				...
				<div>
					...
					<span>통신판매업신고번호 : 제 2020-서울서초-2839 호 <a href="https://www.homesool.com/service/membership_lounge.php#" class="btn_licensee_info" onclick="gd_popup_bizInfo(&#39;7768501398&#39;); return false;">[사업자번호조회]</a></span>
				</div>
				<div>
...
<span class="btn_scroll_top"><a href="https://www.homesool.com/service/membership_lounge.php#TOP"><img src="<%=cp%>/sool/main_files/btn_scroll_top.png" alt="상단으로 이동"></a></span>
