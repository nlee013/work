...
<table>
<tr align="left">
	<td colspan="3">이미지/<a href="<%=cp %>/sool/main.com">Home</a>>회원가입>약관동의</td>
</tr>	
<tr>
	<td colspan="3">회원가입</td>
</tr>
<tr>
	<td colspan="3">홈술닷컴의 회원이 되셔서 회원등급할인/할인쿠폰/적립금 등 다양한 서비스를 받으세요.</td>
</tr>
<tr>
	<td>STEP 1 약관동의</td>
	<td>STEP 2 정보입력</td>
...
<tr>
	...
	<td><input type="button" value=" 다음단계" onclick="checkNext();"/></td>
</tr>
