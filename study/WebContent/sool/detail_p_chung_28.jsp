              ...
              <div class="item_photo_big">
              		 <div class="item_photo_big">
						<span class="img_photo_big">
							<img src="./detail_files/p_chung/1000000053_wlist_035.jpg
							" width="380" name="img1"
...
" width="100"
                       			...
                       			onmouseover="fimg('./detail_files/p_chung/1000000053_wlist_035.jpg
')">
                       		
                       		<img src="./product_files/하얀까마귀1.png" width="100"
                       			style="border: 1px; border-radius: 0.5em;"
                       			onmouseover="fimg('./product_files/하얀까마귀1.png')">
                       				
							<img src="./product_files/하얀까마귀2.png" width="100"
                       			style="border: 1px; border-radius: 0.5em;"
                       			onmouseover="fimg('./product_files/하얀까마귀2.png')">
                       			
                       		<img src="./product_files/하얀까마귀3.png" width="100"
                       			style="border: 1px; border-radius: 0.5em;"
