...
<tr>
		<td align="center">
			<button onclick="goHome();" class="login100-form-btn" style="width :420px; height :65px; color : #000000; background-color: #ededed; border: 0">
				메인으로 가기					
			</button>
			
			
		
			<button onclick="goLogin();" class="login100-form-btn" style="width :420px; height :65px; color : #fff; background-color: #eda71a; border: 0">
				로그인하기
			</button>
