...
<!-- 		<a href="https://www.homesool.com/main/index.php#;" class="n_btn_all_menu_open">전체카테고리</a> -->
			...
			<ul class="gnb_new"> 
				...
				<li><a href="<%=cp%>/homesool/list_bp.com">Best홈술</a></li>
...
<div class="content">
    ...
    <div class="goods_list_item">
        ...
        <div class="goods_list_item_tit">
            <h2 class="tit_38 center">Best 홈술</h2>
        </div>
        
        <div class="list_item_category mt40">
            <ul>
                <li class="">
                    <a href="<%=cp%>/homesool/mak.com"><span>추천홈술</span></a>
                </li>
                <li class="">
                    <a href="<%=cp%>/homesool/soju.com"><span>신제품</span></a>
                </li>
                <li class="on">
                    <a href="<%=cp%>/homesool/chung.com"><span>Best</span></a>
                </li>
                <li class="">
                    <a href="<%=cp%>/homesool/wine.com"><span>이달의 혜택</span></a>
                </li>             
            </ul>
        </div>
              ...
              <div class="item_photo_big">
              		 ...
              		 <div class="item_photo_big">
						<span class="img_photo_big">
							<img src="./detail_files/p_chung/1000000219_wlist_027.jpg" width="380"
								alt="느린마을약주" title="느린마을약주" class="middle"
								style="border: 1px; border-radius: 1em;">
							
							
							<div style=" width:60px; color:#fff; background-color: #f2a03d;
	    						border-radius: 0.3em;">
	    						<button onclick="<%=cp%>/homesool/">
	   					 		구매하기
	   					 		</button>
	    					</div>
